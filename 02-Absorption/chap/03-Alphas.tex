...
A small anomaly can be seen at $d_\text{max}=\SI{16}{\milli\meter}$ which can be interpreted as the maximal distance the alphas can travel before ionizing completely.
