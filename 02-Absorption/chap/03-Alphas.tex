...
\begin{itemize}
	...
	\item \textbf{Dead time:} Although the tube is operated within the pleateau region, dead time is taken into account. Equations \ref{eq:dead_time} and \ref{eq:dead_time_corr} hold.
\end{itemize}
