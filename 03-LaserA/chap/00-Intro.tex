...
The error in $S$ is calculated using the fitting tool \textit{kafe}\footnote{\url{https://github.com/dsavoiu/kafe}}, assuming a statistical error of \SI{1}{\mm} for the distances $d_n$.

A second error source is the wavelength $\lambda$ of the He-Ne laser.
