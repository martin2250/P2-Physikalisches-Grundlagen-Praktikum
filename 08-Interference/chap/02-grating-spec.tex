...
\begin{table}[b!]
	...
	\begin{tabular}{S|SSS|S}
		...
		\midrule
		1	&	\SI{185}{\degree}\SI{33}{\arcminute}	&	\SI{174}{\degree}\SI{30}{\arcminute}	&	\SI{5}{\degree}\SI{32}{\arcminute}	&	163.4	\\
...
\begin{table}[b!]
	...
	\begin{tabular}{SS|SS|SS}
		\toprule
		{order $n$}	&	{color}	&	\multicolumn{2}{c|}{angle $\phi$ (left/right)}	&	{mean diff. angle} &	{wavelength $\lambda$}	\\
		&&&&	{$\Delta\phi$}	& {(\si{\nm})}\\
		\midrule
		{1}	&	{violet-blue}	&	\darc{196}{32}	&	\darc{163}{28}	&	\darc{16}{32}	&	461.8	\\
		{}	&	{blue}	&	\darc{196}{43}	&	\darc{163}{19}	&	\darc{16}{42}	&	466.3	\\
		{}	&	{cyan}	&	\darc{197}{20}	&	\darc{163}{0}	&	\darc{17}{1}	&	474.9	\\
		{}	&	{red}	&	\darc{202}{47}	&	\darc{157}{14}	&	\darc{22}{47}	&	628.2	\\
		\midrule
		{2}	&	{violet-blue}	&	\darc{214}{39}	&	\darc{145}{14}	&	\darc{34}{43}	&	462.0	\\
		{}	&	{blue}	&	\darc{215}{1}	&	\darc{144}{51}	&	\darc{35}{5}	&	466.4	\\
		{}	&	{cyan}	&	\darc{215}{46}	&	\darc{144}{6}	&	\darc{35}{50}	&	475.0	\\
		{}	&	{red}	&	\darc{230}{30}	&	\darc{129}{2}	&	\darc{50}{44}	&	628.2	\\
		\bottomrule
	\end{tabular}
\end{table}
