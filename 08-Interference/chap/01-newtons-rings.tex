...
\begin{figure}[tbp]
	...
	\begin{subfigure}{.32\textwidth}
		\centering
		\includegraphics[width=\textwidth]{data/plots/1-1-blue.pdf}
		\caption{Blue LED (\SI{465}{\nm})}
		\caption*{$\frac{r_k^2}{k} = \SI{0.154}{\mm\squared}$}
	\end{subfigure}
	\begin{subfigure}{.32\textwidth}
		\centering
		\includegraphics[width=\textwidth]{data/plots/1-1-yellow.pdf}
		\caption{Yellow LED (\SI{590}{\nm})}
		\caption*{$\frac{r_k^2}{k} = \SI{0.173}{\mm\squared}$}
	\end{subfigure}
	\begin{subfigure}{.32\textwidth}
		\centering
		\includegraphics[width=\textwidth]{data/plots/1-2-yellow-water.pdf}
		\caption{Yellow LED (\SI{590}{\nm}) in Water}
