...
However, the audible signal was superimposed by the \SI{50}{\hertz} mains hum, which causes an \todo{not an envelope, it's only a voltage offset} envelope oscillation also visible in the diagram.
\begin{figure}[tbp]
	\centering
