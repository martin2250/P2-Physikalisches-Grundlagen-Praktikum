...
All tested components except for the LDR show hysteresis, due to stray capacitances, inductances and diode recovery times, which makes them less useful as power rectifiers (diodes) or optical communication (LEDs).
