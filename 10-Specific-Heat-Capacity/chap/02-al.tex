...
The heating process then is carried out in two different ways:	\todo{doesn't just take place by itself (well sorta), better is carried out}
\begin{itemize}
...
The fit function $T(t)=a\cdot t^b + c$ is applied to the heat curve with connected heater.	%guessing that sentence is going to change anyways
